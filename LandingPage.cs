...
namespace CookieClicker_Automation
{
    public class LandingPage : BasePage
    {
        ...
        public IWebElement YourNameTextInputBox => driver.FindElement(By.XPath("//button[text()='Start!']"));
        ...
        public IWebElement ScoreTitle => driver.FindElement(By.XPath("//th[text()='Score']"));
